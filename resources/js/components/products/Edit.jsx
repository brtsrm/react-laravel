...
const Edit = () => {
    ...
    const updateProduct = async (e) => {
        ...
        await axios.post(`/api/update_product/${id}`, formData).then((data) => {
            toast.fire({
                icon: 'success',
                ...
                <div className="card_wrapper">
                    <div className="wrapper_left">
                        <div className="card">
                            ...
                            <textarea cols="30" rows="10" value={description} onChange={(event) => {
                                ...
                                <ul className="images_list">
                                    ...
                                    <li className="image_item">
                                        <form className="image_item-form">
                                            <label htmlFor="" className="image_item_form--label">Add Image</label>
